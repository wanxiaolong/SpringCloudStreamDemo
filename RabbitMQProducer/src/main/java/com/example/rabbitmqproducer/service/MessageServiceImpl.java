 ...
 * 这些Class是接口，SpringCloudStream会帮我们实现这些接口。
 *
 ...
 * 这里表示将创建Channels.class中@Output指定的MessageChannel，并将其与Binder绑定
 */
...
public class MessageServiceImpl implements IMessageService {
     ...
     * 这里MessageChannel是个接口，我们并没有实现，但是SpringCloudStream会帮我们实现它，我们只需要获取它，并使用它。
     */
    @Autowired
